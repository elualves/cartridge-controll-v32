...
public class CorFormController implements Initializable {
	...
	private Cor getFormData() {
		...
		if (txtCor.getText() == null || txtCor.getText().trim().equals("")) {
			exception.addError("Cor", " << Informe a cor para salvar");
		}
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldMaxLength(txtCor, 30);
	}
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		if (fields.contains("Cor")) {
			labelErrorCor.setText(errors.get("Cor"));
		}
	}
}
